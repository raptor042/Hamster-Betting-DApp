            ...
            <div className="hidden sm:grid grid-cols-3 gap-4 py-4 px-10">
                ...
                {!user && 
                    <div className="px-10 flex justify-end">
                        <div className="my-2">
                            <button onClick={handleClick} className="rounded-lg animate-pulse hover:animate-none font-black text-white text-center text-xl bg-[#112330] p-4">{!loading && "SIGN IN"}</button>
                        </div>
                        {loading &&
                ...
                {!user && 
                    <div className="basis-2/6">
                        <div className="flex justify-end">
                            <div>
                                <button onClick={handleClick} className="rounded-lg animate-pulse hover:animate-none font-black text-white text-center text-xs bg-[#112330] p-2">{!loading && "SIGN IN"}</button>
                            </div>
                            {loading &&
                                <div className="flex justify-center"> 
                                    <div role="status">
