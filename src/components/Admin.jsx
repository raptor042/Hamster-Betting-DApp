...
export default function Admin() {
    ...
    const withdraw_fees = async (e) => {
        ...
        if(isConnected) {
            ...
            try {
                await betting.withdrawFees({ value: ethers.parseEther("0") })
    ...
    const withdraw = async (e) => {
        ...
        if(isConnected) {
            ...
            try {
                await betting.withdraw({ value: ethers.parseEther("0") })

                setLoadingWETH(false)
            } catch (error) {
                console.log(error)
                toast.error("An error occured while processing this request.")
                setLoadingWETH(false)
                ...
                <div className="rounded-lg bg-[#0F212E] border border-[#8D969C] px-8 py-4 sm:px-16 sm:py-8">
                    ...
                    {start && pick &&
                        <div className="flex justify-center items-center mt-8">
                            ...
                            {!loadingWF &&
                                <div className="m-2">
                                    <button onClick={withdraw_fees} className="rounded-lg animate-pulse hover:animate-none font-medium text-white text-center text-md bg-[#45E4AE] p-4">
                                        Withdraw Fees
                                    </button>
                                </div>
                            }
                            ...
                            {!loadingWETH &&
                                <div className="m-2">
                                    <button onClick={withdraw} className="rounded-lg animate-pulse hover:animate-none font-medium text-white text-center text-md bg-[#DE8508] p-4">
                                        Withdraw ETH
                                    </button>
                                </div>
                            }
